...
class TextGIN(nn.Module): 
    ...
    def __init__(self, embedding_matrix, opt): 
        ...
        self.graph_convs1 = nn.ModuleList() 
        self.graph_convs2 = nn.ModuleList() 
        ...
        for i in range(opt.num_layers): 
            if opt.graph_conv_type == 'gat-mod': 
                graph_conv1 = TextGATConv_mod(hidden_dim=opt.hidden_dim, # F = H * C 
                            ...
                            norm=opt.norm) 
                graph_conv2 = TextGATConv_mod(hidden_dim=opt.hidden_dim, # F = H * C 
                            num_heads=opt.graph_conv_attention_heads, # H 
                            attn_dropout=opt.graph_conv_attn_dropout,
                            ffn_dropout=opt.ffn_dropout, 
                            edge_dim=opt.deprel_dim, 
                ...
                graph_conv1 = TextGCNConv(opt.hidden_dim, opt.deprel_dim) 
                graph_conv2 = TextGCNConv(opt.hidden_dim, opt.deprel_dim) 
            elif opt.graph_conv_type == 'gin': 
                graph_conv1 = TextGINConv(opt.hidden_dim, 
                            dropout_ratio=opt.ffn_dropout, 
                            norm=opt.norm, 
                            edge_dim=opt.deprel_dim) 
                graph_conv2 = TextGINConv(opt.hidden_dim, 
                            dropout_ratio=opt.ffn_dropout, 
                            norm=opt.norm, 
                            edge_dim=opt.deprel_dim) 
            elif opt.graph_conv_type == 'gat':
                graph_conv1 = TextGATConv(hidden_dim=opt.hidden_dim, # F = H * C 
                            num_heads=opt.graph_conv_attention_heads, # H 
                            attn_dropout=opt.graph_conv_attn_dropout,
                            ffn_dropout=opt.ffn_dropout, 
                            edge_dim=opt.deprel_dim, 
                            norm=opt.norm) 
                graph_conv2 = TextGATConv(hidden_dim=opt.hidden_dim, # F = H * C 
                            num_heads=opt.graph_conv_attention_heads, # H 
                            attn_dropout=opt.graph_conv_attn_dropout,
                            ffn_dropout=opt.ffn_dropout, 
                            edge_dim=opt.deprel_dim, 
                            norm=opt.norm) 
            self.graph_convs1.append(graph_conv1) 
            self.graph_convs2.append(graph_conv2) 
    ...
    def forward(self, inputs): 
        ...
        for i in range(self.opt.num_layers): 
            ...
            # Transformer Layer is replaced 
            h = self.graph_convs2[i](h, adj, e) 
